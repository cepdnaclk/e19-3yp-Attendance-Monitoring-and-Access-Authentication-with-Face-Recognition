...
# Enroll the fingerprint with device
def enroll_print(emp_id):
    ...
    state = enroll_finger(emp_id)
    return state


# check with the entered fingerprint with entered one
def find_print():
    if finger.read_templates() != adafruit_fingerprint.OK:
        raise RuntimeError("Failed to read templates")
    print("Fingerprint templates: ", finger.templates)
    ...
    if get_fingerprint():
        ...
        return finger.finger_id, True
    else:
        print("Finger not found")
        return 0, False


# Delete the entered fingerprint
def delete_print():
    if finger.read_templates() != adafruit_fingerprint.OK:
        raise RuntimeError("Failed to read templates")
    print("Fingerprint templates: ", finger.templates)
