...
def create_folder(folder_name):
    ...
    if folder_name:
        ...
        fr_path = os.path.join(root_path, "face_recognition")
        ...
        if not os.path.exists(folder_path):
            ...
            print(f"Folder '{folder_name}' created in 'face_recognition' folder.")
        else:
            print(f"Folder '{folder_name}' already exists in 'face_recognition/datasets' folder.")
    else:
